 ...
 * — one-shot Q&A over the organisation's tenant-wide capability state,
 * rendered directly on /org/capability. Each query replaces the previous
 * answer; no thread, no history. Learner selection reuses the existing
 * capability table's rows — this panel never fetches learner data itself,
 * it only forwards the id the parent page already rendered.
 */
