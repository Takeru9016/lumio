...
export function TextEditor({
  ...
  if (!editor) {
    return (
      <div className="w-full min-h-[300px] rounded-lg border border-border bg-surface-2 animate-pulse" />
    );
  }
